...
import (
	...
	"github.com/avh17/silo/Projects/silo/internal/answer"
	"github.com/avh17/silo/Projects/silo/internal/embed"
	"github.com/avh17/silo/Projects/silo/internal/retriever"
	"github.com/avh17/silo/Projects/silo/internal/store"
)
...
func main() {
	...
	case "index":
		...
		path := os.Args[2]
		index, err := indexPath(db, path)
		if err != nil {
			log.Fatal(err)
		}
		fmt.Println("Index created at", index)
	case "ask":
		if len(os.Args) != 3 {
